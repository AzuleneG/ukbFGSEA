---
title: "The ukbFGSEA README"
author: "He Zhu, Pengjun Guo"
date: "2024-08-08"
...
significant_with_asd %>% 
  kableExtra::kable(caption = paste0(nrow(.), " phenotypes significantly enriched with ASD genes")) %>% 
  kableExtra::kable_styling(bootstrap_options = c("s","b","h","c","r")) %>% 
  kableExtra::scroll_box(width = "100%", height = "600px") 

significant_with_dd %>% 
  kableExtra::kable(caption = paste0(nrow(.), " phenotypes significantly enriched with DD genes")) %>% 
  kableExtra::kable_styling(bootstrap_options = c("s","b","h","c","r")) %>% 
  kableExtra::scroll_box(width = "100%", height = "600px") 

significant_with_ndd %>% 
  kableExtra::kable(caption = paste0(nrow(.), " phenotypes significantly enriched with NDD genes")) %>% 
  kableExtra::kable_styling(bootstrap_options = c("s","b","h","c","r")) %>% 
  kableExtra::scroll_box(width = "100%", height = "600px") 
